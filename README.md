...
*   Wake and Laydown animations are bad
    *   They are placeholders, taken from the Fox asset, so they don't work quite right, but they're better than nothing until I can figure out how to do some basic animation
